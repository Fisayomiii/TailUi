...
const Gradientduotone = ({ buttonareaRef, copyToClipboard }: any) => {

    return (
        <>
            <div className='pt-5'>
                <h1 className="text-2xl pb-2 sm:text-1xl text-slate-900 tracking-tight">Gradient duotone</h1>
                <p className="mt-2 text-md text-slate-700 dark:text-slate-400">These buttons use a style that includes two contrasted colors creating an impressive mesh gradient effect.</p>
                <div className='mt-10 p-7 mt-4 overflow-hidden rounded-lg bg-white ring-1 ring-slate-900/5'>
                    ...
                    <div className="flex pl-[1rem] flex-wrap flex-1 gap-x-1 pb-10 pt-5">
                        ...
                        <button type="button" className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" ref={buttonareaRef}>Purple to Blue</button>
