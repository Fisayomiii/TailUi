...
const Basicbtns = () => {
  ...
  return (
    <>
      <div className='pt-5'>
        <h1 className="text-2xl pb-2 sm:text-1xl text-slate-900 tracking-tight">Basic Button ( Default )</h1>
        <div className='mt-10 p-7 mt-4 overflow-hidden rounded-lg bg-white ring-1 ring-slate-900/5'>
          ...
          <div className="flex pl-[1rem] flex-wrap flex-1 gap-x-1 pb-10 pt-5">
            <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" ref={buttonareaRef}>Default</button>
