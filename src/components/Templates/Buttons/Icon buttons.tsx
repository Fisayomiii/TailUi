...
const Iconbutton = () => {
    ...
    return (
        <>
            <div className='pt-5'>
                <h1 className="text-2xl pb-2 sm:text-1xl text-slate-900 tracking-tight">Icon Button</h1>
                <p className="mt-2 text-md text-slate-700 dark:text-slate-400">Sometimes you need a button to indicate an action using only an icon.</p>
                <div className='mt-10 p-7 mt-4 overflow-hidden rounded-lg bg-white ring-1 ring-slate-900/5'>
                    ...
                    <div className="flex pl-[1rem] flex-wrap flex-1 gap-x-1 pb-10 pt-5" >
                        ...
                        <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" ref={buttonareaRef}>
