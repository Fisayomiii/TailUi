...
const Testimonialcard = ({ buttonareaRef, copyToClipboard }: any) => {
            ...
            <div className='pt-5 '>
                ...
                <div className='mt-10 p-7 mt-4 overflow-hidden rounded-lg bg-white ring-1 ring-slate-900/5'>
                    ...
                    <div className="flex justify-center mb-5 p-12">
                        <div className="w-full max-w-md px-8 py-4 mt-16 bg-white rounded-lg shadow-lg dark:bg-gray-800" ref={buttonareaRef}>
