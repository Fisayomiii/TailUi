...
const Productcardtwo = ({ buttonareaRef, copyToClipboard }: any) => {
            ...
            <div className='pt-5 '>
                ...
                <div className='mt-10 p-7 mt-4 overflow-hidden rounded-lg bg-white ring-1 ring-slate-900/5'>
                    ...
                    <div className="flex justify-center mb-5 p-12">
                        ...
                        <div className="w-full max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700" ref={buttonareaRef}>
                            <a href="#">
